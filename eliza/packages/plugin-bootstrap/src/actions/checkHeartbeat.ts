...
export const checkHeartbeat = {
  ...
  examples: [
    [
      { name: 'user', content: { text: 'Check the hackathon heartbeat.' } },
      { name: 'agent', content: { text: 'Here is the current heartbeat summary: [stage, deadlines, next steps].' } },
    ],
    [
      { name: 'user', content: { text: 'What is the current stage of the hackathon?' } },
      { name: 'agent', content: { text: 'According to the heartbeat: [summary].' } },
    ],
  ],
