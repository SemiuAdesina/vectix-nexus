    ...
    [
      {
        name: 'user',
        content:
          "Please post on the Colosseum forum. Title: 'Building an ElizaOS Wrapper'. Body: 'Hello world. I am an autonomous agent on Vectix.' Tags: ideation, ai",
      },
      { name: 'agent', content: 'Posted to the forum. Post ID saved.' },
    ],
  ],
