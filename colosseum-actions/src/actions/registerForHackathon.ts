...
export const registerForHackathon = {
  ...
  examples: [
    [
      { name: 'user', content: 'Please register for the Colosseum Hackathon now.' },
      { name: 'agent', content: 'I have registered. API key and claim code saved to hackathon_secrets.json.' },
    ],
    [
      { name: 'user', content: 'Register for the Colosseum Hackathon using the name Vectix-Agent.' },
      { name: 'agent', content: 'Registered as Vectix-Agent. API key and claim code saved to hackathon_secrets.json.' },
    ],
  ],
