...
describe('public-api.routes', () => {
    ...
    describe('GET /agents', () => {
        it('returns agents for authenticated API user', async () => {
            ...
            const handler = (agentsRouter as any).stack.find((r: any) =>
                r.route?.path === '/agents' && r.route.methods.get
    ...
    describe('GET /agents/:id', () => {
        it('returns 404 when agent not found', async () => {
            ...
            const { default: agentsRouter } = await import('./public-api/agents.routes');
            const handler = (agentsRouter as any).stack.find((r: any) =>
                r.route?.path === '/agents/:id' && r.route.methods.get
            )?.route.stack[2].handle;
    ...
    describe('POST /agents/:id/trade', () => {
        it('returns 400 when required fields missing', async () => {
            ...
            const handler = (tradeRouter as any).stack.find((r: any) =>
                r.route?.path === '/agents/:id/trade'
    ...
    describe('GET /market/trending', () => {
        it('returns delayed data for free tier', async () => {
            ...
            const handler = (marketRouter as any).stack.find((r: any) =>
                r.route?.path === '/market/trending'
            )?.route.stack[1].handle;
