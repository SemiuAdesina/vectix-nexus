    ...
    <div className="mb-6">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-teal-500/10 flex items-center justify-center border border-teal-500/30 shadow-[0_0_12px_-4px_rgba(20,184,166,0.2)]">
        ...
        <div className="flex gap-2">
          ...
          <Link href="/create">
            <Button size="sm" className="bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white border-0 shadow-lg shadow-teal-500/20">
...
function EmptyState() {
  return (
    <div className="w-full">
      <div className="relative rounded-2xl border border-slate-700/50 bg-slate-900/50 backdrop-blur-sm p-12 text-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-teal-500/5 via-transparent to-transparent pointer-events-none" />
        <div className="relative">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center mx-auto mb-6 shadow-lg shadow-teal-500/25 ring-2 ring-teal-500/30 ring-offset-2 ring-offset-slate-950">
            <Bot className="w-10 h-10 text-white drop-shadow-sm" />
          </div>
          <h2 className="text-2xl md:text-3xl font-bold mb-3 text-white">Deploy Your First Agent</h2>
          <div className="w-16 h-0.5 rounded-full bg-gradient-to-r from-teal-500 to-cyan-500/50 mx-auto mb-6" />
          ...
          <Link href="/create" className="inline-flex">
            <Button
              size="lg"
              className="bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white border-0 shadow-lg shadow-teal-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
            >
