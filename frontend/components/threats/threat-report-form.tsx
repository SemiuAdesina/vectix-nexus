...
const inputClass = 'w-full px-4 py-2 bg-slate-800/80 border border-slate-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all disabled:opacity-50';
    ...
    <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 p-6 shadow-[0_0_24px_-8px_rgba(20,184,166,0.12)]">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-white">Report Threat</h2>
            <p className="text-sm text-slate-400">Submit a threat report to Vectix Foundry security team</p>
          </div>
        </div>
        <button
          type="button"
          ...
          aria-label="Close"
          disabled={submitting}
          className="p-1.5 hover:bg-teal-500/10 hover:text-teal-400 rounded-lg transition-colors text-slate-400 disabled:opacity-50"
        >
          <X className="w-4 h-4" />
        </button>
      </div>
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex gap-3 justify-end pt-2">
          <button
            ...
            onClick={onClose}
            disabled={submitting}
            className="px-4 py-2 border border-teal-500/30 rounded-lg hover:bg-teal-500/10 hover:border-teal-500/50 hover:text-teal-400 text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white rounded-lg flex items-center gap-2 shadow-lg shadow-teal-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
