...
const CARD_CLASS = 'rounded-xl sm:rounded-2xl border border-slate-700/50 bg-slate-900/50 p-4 sm:p-6 shadow-[0_0_24px_-8px_rgba(20,184,166,0.08)]';
const ICON_BOX_CLASS = 'w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-teal-500/15 flex items-center justify-center border border-teal-500/30 shrink-0';

export default function BugBountyPage() {
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold mb-1 sm:mb-2 text-white">Bug Bounty Program</h1>
      ...
      <div className={CARD_CLASS}>
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          ...
          <h2 className="text-sm sm:text-xl font-semibold text-white">Program Overview</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div className={CARD_CLASS}>
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <h2 className="text-sm sm:text-xl font-semibold text-white">Severity Levels</h2>
          </div>
          <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
            <div className="p-2.5 sm:p-3 rounded-lg sm:rounded-xl border border-slate-700/50 bg-slate-800/50">
        ...
        <div className={CARD_CLASS}>
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <h2 className="text-sm sm:text-xl font-semibold text-white">Rewards</h2>
          </div>
          <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
            <div className="flex justify-between p-2.5 sm:p-3 rounded-lg sm:rounded-xl border border-slate-700/50 bg-slate-800/50">
            ...
            <p className="text-slate-400 mt-3 sm:mt-4">
      ...
      <div className={CARD_CLASS}>
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          ...
          <h2 className="text-sm sm:text-xl font-semibold text-white">Scope</h2>
        </div>
        <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
          <div>
            <span className="font-medium text-white">In Scope:</span>
            <ul className="list-disc list-inside ml-3 sm:ml-4 mt-1 text-slate-400">
      ...
      <div className={CARD_CLASS}>
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          ...
          <h2 className="text-sm sm:text-xl font-semibold text-white">Report a Vulnerability</h2>
        </div>
        <p className="text-xs sm:text-sm text-slate-400 mb-3 sm:mb-4">
          Use the security reporting endpoint or contact security@vectix-nexus.com
        </p>
        <div className="p-3 sm:p-4 rounded-lg sm:rounded-xl border border-slate-700/50 bg-slate-800/80">
          <code className="text-[10px] sm:text-sm font-mono text-teal-400 break-all">POST /api/security/bug-report</code>
        </div>
      </div>
    </div>
  );
